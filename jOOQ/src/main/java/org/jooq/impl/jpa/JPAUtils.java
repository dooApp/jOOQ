...
public class JPAUtils {
    ...
    /**
     * Returns the nearest parent discriminator column name based on {@link DiscriminatorColumn DiscriminatorColumn
     * annotation}.<br>
    ...
    public static String getParentDiscriminatorColumn(Class<?> jpaClass) {
        if (jpaClass.getSuperclass().equals(Object.class) || jpaClass.getSuperclass().isAnnotationPresent(MappedSuperclass.class)) {
